#=
user_paths_template.jl - Template for Local Windows Path Configuration
...
EXAMPLE PATHS BELOW ARE FROM USER "dbernal" - MODIFY FOR YOUR MACHINE
=#
...
const ELECTRIC_LOAD_PATH = "/data/facility_load_profiles/"
...
const NG_LOAD_PATH = "/data/facility_annual_energy_consumption/"
...
const BASELOAD_PATH = "/data/baseload sizes/"
...
const PV_ROOF_PROD_PATH = "/data/pvwatts_roof_csvs/"

# Ground-mounted fixed-tilt PV production factors
const PV_GROUND_FIXED_PATH = "/data/pvwatts_ground_fixed_csvs/"

# Ground-mounted single-axis tracking PV production factors
const PV_GROUND_AXIS_PATH = "/data/pvwatts_ground_axis_csvs/"
...
const WIND_RESOURCE_PATH = "/data/wind_resource_data/"
...
const PARCEL_FILE_PV = "/data/pnnl_parcel_land_coverage_data/updated_1_28_2025/LC_facility_parcels_NREL_01_28_25.csv"

# Full path to the Wind parcel/site list CSV file
# This is the wind-specific site list with exclusions applied
const PARCEL_FILE_WIND = "/data/pnnl_parcel_land_coverage_data/wind_sitelist/wind_sitelist_3x7_no_sites_with_exclusions.csv"
